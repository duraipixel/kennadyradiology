...
<div id="home-banner-carousel" class="carousel slide carousel-fade" data-ride="carousel">
   ...
   <div class="carousel-inner" role="listbox">
      <div class="carousel-item active">
         <picture>
            <source media="(max-width:960px)" srcset="<?php echo BASE_URL;?>/static/images/home-banner/banner-image1-mob.jpg" />
            <img src="<?php echo BASE_URL;?>/static/images/home-banner/banner-image1.jpg"class="d-block w-100" alt="" />
         </picture>
         <div class="carousel-caption">
            <h1>Spreading Light Helping Cure &amp; Nurturing Lives</h1>
            <div class="animated fadeInUp"><a href="#" class="banner-btn">Shop Now<i class="flaticon-right-arrow"></i></a></div>
         </div>
      </div>
      <div class="carousel-item">
         <picture>
            <source media="(max-width:960px)" srcset="<?php echo BASE_URL;?>/static/images/home-banner/banner-image2-mob.jpg" />
            <img src="<?php echo BASE_URL;?>/static/images/home-banner/banner-image2.jpg"class="d-block w-100" alt="" />
         </picture>
         <div class="carousel-caption">
            <h1>Spreading Light Helping Cure &amp; Nurturing Lives</h1>
            <div class="animated fadeInUp"><a href="#" class="banner-btn">Shop Now<i class="flaticon-right-arrow"></i></a></div>
      ...
      <div class="carousel-item">
         <picture>
            <source media="(max-width:960px)" srcset="<?php echo BASE_URL;?>/static/images/home-banner/banner-image3-mob.jpg" />
            <img src="<?php echo BASE_URL;?>/static/images/home-banner/banner-image3.jpg"class="d-block w-100" alt="" />
         </picture>
         <div class="carousel-caption">
            <h1>Spreading Light Helping Cure &amp; Nurturing Lives</h1>
            <div class="animated fadeInUp"><a href="#" class="banner-btn">Shop Now<i class="flaticon-right-arrow"></i></a></div>
      ...
      <div class="row">
         <div class="col">
            ...
            <div class="explore-products">
               <div>
                  <img src="<?php echo BASE_URL;?>/static/images/category-icon1.png" alt="" />
                  <h4>Protection Shields</h4>
               </div>
               <div>
                  <img src="<?php echo BASE_URL;?>/static/images/category-icon2.png" alt="" />
                  <h4>Protection Apparel</h4>
               </div>
               <div>
                  <img src="<?php echo BASE_URL;?>/static/images/category-icon3.png" alt="" />
                  <h4>Protection Eyewear</h4>
               </div>
               <div>
                  <img src="<?php echo BASE_URL;?>/static/images/category-icon4.png" alt="" />
                  <h4>Digital Radiography</h4>
               </div>
               <div>
                  <img src="<?php echo BASE_URL;?>/static/images/category-icon5.png" alt="" />
                  <h4>Protection Gloves</h4>
               </div>
               <div>
                  <img src="<?php echo BASE_URL;?>/static/images/category-icon6.png" alt="" />
                  <h4>Analogue Xray Cassettes</h4>
               </div>
            </div>
         </div>
      </div>
