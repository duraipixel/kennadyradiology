               ...
               <div class="row hide-on-fixed">
                  ...
                  <div class="col-sm-8 col-md-8 col-lg-8 col-xl-6 p-0">
                     ...
                     <div class="header-right-dropdown language">
                        <button class="dropbtn"><img class="yellow-img" src="<?php echo BASE_URL; ?>/static/images/language.png" alt="" /><img class="purple-img" src="<?php echo BASE_URL; ?>/static/images/language1.png" alt="" /> English &nbsp; <i class="fa fa-angle-down"></i></button>
                        <div class="dropdown-content">
                           <a href="">English</a>
                           <a href="">Europe</a>
                        </div>
               ...
               <div class="row">
                  <div class="col-sm-2 col-md-2 col-lg-8 col-xl-9 posi-unset">
                     <div class="collapse navbar-collapse" id="mobile_nav">
                        ...
                        <a class="mobile-logo d-block d-lg-none" href="#"><img src="<?php echo BASE_URL; ?>/static/images/logo.png" alt="" /></a>
                        <ul class="navbar-nav navbar-light">
                              ...
                              <div class="dropdown-menu megamenu sm-menu border-top" aria-labelledby="dropdown01">
                                 <div class="row">
                                    ...
                                    <div class="col-sm-12 col-lg-4">
                                       <a class="dropdown-item" href="<?php echo BASE_URL; ?>product-listing/" data-src="<?php echo BASE_URL; ?>/static/images/products/product-image1.png">Radiation Protection 1</a>
                                    ...
                                    <div class="col-sm-4 col-lg-4 text-center d-none d-lg-block">
                                       <img src="<?php echo BASE_URL; ?>/static/images/products/product-image1.png" alt="" class="dropdown-image wow fadeIn" data-wow-duration="0.3s" />
                                    </div>
                                 </div>
                              </div>
                           </li>
                           <li class="nav-item dropdown megamenu-li dmenu">
                              <a class="nav-link" href="" id="dropdown02" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Imaging Accessories<span class="dropdown-toggle"></span></a>								
                              <div class="dropdown-menu megamenu sm-menu border-top" aria-labelledby="dropdown01">
                                 <div class="row">
									<div class="col-sm-4 col-lg-2">
                                    </div>
                                    <div class="col-sm-12 col-lg-4">
                                       <a class="dropdown-item" href="<?php echo BASE_URL; ?>product-listing/" data-src="<?php echo BASE_URL; ?>/static/images/products/product-image1.png">Imaging Accessories 1</a>
                                       <a class="dropdown-item" href="<?php echo BASE_URL; ?>product-listing/" data-src="<?php echo BASE_URL; ?>/static/images/products/product-image2.png">Imaging Accessories 2</a>
                                       <a class="dropdown-item" href="<?php echo BASE_URL; ?>product-listing/" data-src="<?php echo BASE_URL; ?>/static/images/products/product-image3.png">Imaging Accessories 3</a>
                                       <a class="dropdown-item" href="<?php echo BASE_URL; ?>product-listing/" data-src="<?php echo BASE_URL; ?>/static/images/products/product-image4.png">Imaging Accessories 4</a>
                                       <a class="dropdown-item" href="<?php echo BASE_URL; ?>product-listing/" data-src="<?php echo BASE_URL; ?>/static/images/products/product-image1.png">Imaging Accessories 5</a>
                                    </div>
                                    <div class="col-sm-4 col-lg-4 text-center d-none d-lg-block">
                                       <img src="<?php echo BASE_URL; ?>/static/images/products/product-image1.png" alt="" class="dropdown-image wow fadeIn" data-wow-duration="0.3s" />
                                    </div>
                           ...
                           <li class="nav-item dropdown megamenu-li dmenu">
                              <a class="nav-link" href="" id="dropdown03" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">OEM Product<span class="dropdown-toggle"></span></a>
                              <div class="dropdown-menu megamenu sm-menu border-top" aria-labelledby="dropdown01">
                                 <div class="row">
									<div class="col-sm-4 col-lg-2">
                                    </div>
                                    <div class="col-sm-12 col-lg-4">
                                       <a class="dropdown-item" href="<?php echo BASE_URL; ?>product-listing/" data-src="<?php echo BASE_URL; ?>/static/images/products/product-image1.png">OEM Product 1</a>
                                       <a class="dropdown-item" href="<?php echo BASE_URL; ?>product-listing/" data-src="<?php echo BASE_URL; ?>/static/images/products/product-image2.png">OEM Product 2</a>
                                       <a class="dropdown-item" href="<?php echo BASE_URL; ?>product-listing/" data-src="<?php echo BASE_URL; ?>/static/images/products/product-image3.png">OEM Product 3</a>
                                       <a class="dropdown-item" href="<?php echo BASE_URL; ?>product-listing/" data-src="<?php echo BASE_URL; ?>/static/images/products/product-image4.png">OEM Product 4</a>
                                       <a class="dropdown-item" href="<?php echo BASE_URL; ?>product-listing/" data-src="<?php echo BASE_URL; ?>/static/images/products/product-image1.png">OEM Product 5</a>
                                    </div>
                                    <div class="col-sm-4 col-lg-4 text-center d-none d-lg-block">
                                       <img src="<?php echo BASE_URL; ?>/static/images/products/product-image1.png" alt="" class="dropdown-image wow fadeIn" data-wow-duration="0.3s" />
                                    </div>
                           ...
                           <li class="nav-item dropdown dmenu">
                              <a class="nav-link" href="" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Knowledge Center<span class="dropdown-toggle"></span></a>
                              <div class="dropdown-menu m-0 p-0 sm-menu border-top" aria-labelledby="dropdown01">
                                 <div class="row">
                                    <div class="col-12">
                                       <a class="dropdown-item" href="#">Knowledge Center 1</a>
                                       <a class="dropdown-item" href="#">Knowledge Center 2</a>
                                       <a class="dropdown-item" href="#">Knowledge Center 3</a>
                                       <a class="dropdown-item" href="#">Knowledge Center 4</a>
                                       <a class="dropdown-item" href="#">Knowledge Center 5</a>
                                    </div>
                                 </div>
                              </div>
                           </li>
                     ...
                     <div class="header-right-dropdown cart-items">
                        ...
                        <div class="dropdown-content">
                           <table class="table mb-0">
                              <tr>
                                 <td>
                                    <a href="#"><img src="<?php echo BASE_URL; ?>/static/images/products/product-image1.png" alt="" class="cart-items-image" /></a>
                              ...
                              <tr>
                                 <td>
                                    <a href="#"><img src="<?php echo BASE_URL; ?>/static/images/products/product-image2.png" alt="" class="cart-items-image" /></a>
