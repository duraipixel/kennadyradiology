...
class common_model extends Model {
	...
	public function savejointventureenquiry($projectid){
 		
		require_once('common_function.php');	
 		$result = savejointventureenquiry($this,$projectid);	
		return $result;
	}
	public function getProjectLocation($projectid){
 		
		require_once('common_function.php');	
 		$result = getProjectLocation($this,$projectid);	
		return $result;
	}
	public function savecontactenquiry($projectid){
 		
		require_once('common_function.php');	
 		$result = savecontactenquiry($this,$projectid);	
		return $result;
	}
	public function savemaintenanceenquiry($projectid){
 		
		require_once('common_function.php');	
 		$result = savemaintenanceenquiry($this,$projectid);	
		return $result;
	}
	
	public function getConstructionDetails($projectid){
 		
		require_once('common_function.php');	
 		$result = getConstructionDetails($this,$projectid);	
		return $result;
	}
	public function getConstructionProjects(){
 		
		require_once('common_function.php');	
 		$result = getConstructionProjects($this);	
		return $result;
	}
	public function saveprojectenquiry(){	
		require_once('common_function.php');
		$rslt_data = saveprojectenquiry($this,$_REQUEST);		
		return $rslt_data;		
	}
	
	public function getLocationBaseProject($filter){
 		
		require_once('common_function.php');	
 		$result = getLocationBaseProject($this,$filter);	
		return $result;
	}
	public function getLocationList(){
 		
		require_once('common_function.php');	
 		$result = getLocationList($this);	
		return $result;
	}
	public function getTestimonialsList(){
 		
		require_once('common_function.php');	
 		$result = getTestimonialsList($this);	
		return $result;
	}
	
	public function getOtherProjects($projectid,$projecttype){
 		
		require_once('common_function.php');	
 		$result = getOtherProjects($this,$projectid,$projecttype);	
		return $result;
	}
	public function getProjectPayments($projectid){
 		
		require_once('common_function.php');	
 		$result = getProjectPayments($this,$projectid);	
		return $result;
	}
	
	public function getProjectLocationMap($projectid){
 		
		require_once('common_function.php');	
 		$result = getProjectLocationMap($this,$projectid);	
		return $result;
	}
	
	public function getProjectSpecification($projectid){
 		
		require_once('common_function.php');	
 		$result = getProjectSpecification($this,$projectid);	
		return $result;
	}
	public function getProjectFloorPlan($projectid){
 		
		require_once('common_function.php');	
 		$result = getProjectFloorPlan($this,$projectid);	
		return $result;
	}
	public function getProjectAvailability($projectid){
 		
		require_once('common_function.php');	
 		$result = getProjectAvailability($this,$projectid);	
		return $result;
	}
	public function getProjectDetailsByProdurl($produrlname=null){
 		
		require_once('common_function.php');	
 		$result = getProjectDetailsByProdurl($this,$produrlname);	
		return $result;
	}
	
	public function getProjectAvailabilityCount($id){
 		
		require_once('common_function.php');	
 		$result = getProjectAvailabilityCount($this,$id);	
		return $result;
	}
	
	
	public function getOnGoingProjectList(){
 		
		require_once('common_function.php');	
 		$result = getOnGoingProjectList($this);	
		return $result;
	}
	...
	public function getCompletedProjectList(){
		...
		require_once('common_function.php');	
 		$result = getCompletedProjectList($this);	
		return $result;
	}
	
	public function getCommercialProjectList(){
 		
		require_once('common_function.php');	
 		$result = getCommercialProjectList($this);	
		return $result;
	}
	
	public function getUpComingProjectList(){
 		//echo "eee"; exit;
		require_once('common_function.php');	
 		$result = getUpComingProjectList($this);	
		return $result;
	}
