				...
				<div class="cart-section">
					  <div class="row">
						<div class="col-md-12">	
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 onepagecheckout-wraper technicaltab-wraper">
		<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
  <div class="panel panel-default">
    <div class="panel-heading panel-1" role="tab" id="headingOne">
      <h4 class="panel-title">
        <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="fasle" aria-controls="collapseOne" >
          <span class="heading-caption">Choose your delivery address</span>
    ...
    <div class="cart-section">
        ...
        <div class="col-md-12">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 onepagecheckout-wraper technicaltab-wraper">
            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
              <div class="panel panel-default">
                <div class="panel-heading panel-1" role="tab" id="headingOne">
                  <h4 class="panel-title"> <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="fasle" aria-controls="collapseOne" >
				  <span class="heading-caption">Choose your delivery address</span> <span class="custom-arrow"></span> </a> </h4>
                </div>
                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" aria-expanded="false">
                  <div class="panel-body">
                    <div class="orderhis shpadd bgwhite ">
                      ...
                      <div  id="addresslist" class="addresslist-wraper">
                        <?php  
                        ...
                        <div class="selectaddress <?php echo (isset($_SESSION['addressid']) && $_SESSION['addressid']==$displayaddress['cus_addressid'])? " active " :''; ?> ">
                          <div class="radiobtncss">
                            ...
                            <span class="seladddet selectname-wraper">
                            ...
                            </span> <span class="seladddet selectmobile-wraper">
                            <div class="seladddet-caption">
                              <div> <?php echo $displayaddress['telephone']; ?> </div>
                            </div>
                            </span> <span class="seladddet selectaddr-wraper">
                            <div class="seladddet-caption"> <?php echo $displayaddress['address']; ?> </div>
                            </span>
                            <div class="addrcommonbtn-wraper"> <span> <a href="javascript:void(0);" class="addrcommon-btn small-lightbtn" onClick="javascript:editaddress(<?php echo $displayaddress['cus_addressid']; ?>);" >Edit</a></span> </div>
                            </label>
                          </div>
                        </div>
                        <?php $cnt++; } ?>
					 ...
					 <?php if($_SESSION['Isguestcheckout']!="1" && $_SESSION['guestckout_sess_id']==""){	 ?>	  
                      <div class="addnewtrig-wraper addnew-trigger">
                        <div class="addnewtrig-inner">
                          <div class="addnew-btn"> <span class="plus-icon">+</span> <span>Add New Delivery Address</span></div>
                        </div>
                      </div>
					 <?php } ?> 
                      ...
                      <div class="addaddresship" id="addnew-address" <?php echo $clsdis; ?>>
                        ...
                        <div class="shpaddfrm">
                          <form class="shppadbdr" id="addressform" action="">
                            ...
                            <div class="form-group row">
                              <div class="col-md-6 pl0 divcountry ">
                                <?php 
											echo $helper->getSelectBox_countrylist_To_cus_address('sel_country','1');
										?>
                              </div>
                              <div class="col-md-6 pl0 divstate"> <?php echo $helper->getSelectBox_state_To_cus_address('sel_state','1');    ?> 
                            ...
                            <div class="row mt30">
                              <div class="col-md-6 pull-right pl0">
                                <button type="button" name="button"  onclick="javascript:Addressform('frmaddress','<?php echo BASE_URL; ?>ajax/Addressform','addressform','Address','<?php echo BASE_URL; ?>checkout');" class="btn btn-success"><span>Save / Update</span></button>
                              </div>
                            </div>
							<?php } else { ?>
							 <div class="row mt30">
                              <div class="col-md-6 pull-right pl0">
                                <button type="button" name="button"  onclick="javascript:Addressform_guest('frmaddress','<?php echo BASE_URL; ?>ajax/Addressform','addressform','Address','<?php echo BASE_URL; ?>checkout');" class="btn btn-success"><span>Proceed</span></button>
                              </div>
                            </div>	
					...
					<?php if($_SESSION['Isguestcheckout']!="1" && $_SESSION['guestckout_sess_id']==""){ ?>	
                    <div class="row ">
                      <div class="col-md-12 text-right mt30"> <span> <a class="btn buynow-btn btndeliveryaddress"
              ...
              <div class="panel panel-default">
                ...
                <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo" aria-expanded="false" >
                  <div class="panel-body">
                    <div class="common-content" id="divshippingcnt"> 
	  ...
	  ?>
			...
			<?php } ?>
                    ...
                    <div class="row ">
                      <div class="col-md-12 text-right mt30"> <span> <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne" class="btn btn-default back-button"> Back </a> </span> <span> <a class="btn buynow-btn btnshippingaddress"
...
foreach($Paymentmethod as $value){ 
	  ...
	  ?>
                    ...
                    <div class="row ">
                      <div class="col-md-12 text-right mt30"> <span> <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne" class="btn btn-default back-button"> Back </a> </span> <span> <a class="btn buynow-btn btnpaymentaddress"
												 role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree"> Proceed </a> </span> </div>
                    </div>
                  </div>
                </div>
			...
			<div id="divordersummarytab">
				...
				-->
                    <div class="row mt30">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12 text-right "> <span> <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" class="btn btn-default back-button"> Back </a> </span> <span> <a href="javascript:void();" class="btn btn-default  paynowbtn"> Pay Now </a> </span> </div>
                    </div>
                  </div>
                </div>
              </div>
			...
			$.ajax({
				...
				success: function(response){
					...
					//$("button").attr('disabled',false);
							...
							$('.radiobtncss input[type=radio]').click(function(){
							if($(this).is(':checked')){
							$(".selectaddress").removeClass("active");
							$(this).parent(".radiobtncss").parent(".selectaddress").addClass("active");
			}
