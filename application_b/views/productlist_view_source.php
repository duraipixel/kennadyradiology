...
<section class="homeslider-section inn">
  <div class="">
    <div class="inner-banners"> <img src="<?php echo BASE_URL;?>uploads/category/<?php echo $catinfo['categoryID']?>/photos/banner/<?php echo $catinfo['catimage']?>" class="img-responsive desktopimg" alt="slider1"> </div>
    <div class="inn-bancnt">
      <div class="container">
        <h4><?php echo $catinfo['categoryName'] ?></h4>
      </div>
    </div>
  </div>
</section>
...
<?php } else 
if(isset($isallproductpage) && $isallproductpage=='1') { ?>

<section class="homeslider-section inn">
  <div class="">
    <div class="inner-banners"> <img src="<?php echo BASE_URL;?>static/images/view_all.jpg" class="img-responsive desktopimg" alt="slider1"> </div>
    <div class="inn-bancnt">
      <div class="container">
...
<section class="cmn-sctr">
<div  class="container">
<?php if(count($productlists)>0){ ?>
<div class="productlistbg clearfix">
  <div class="col-md-12 col-sm-12 col-xs-12 nopad sss2 productcontainer">
    <?php } else{ ?>
      ...
      <div class="protitlesec">
        <div class="row">
          <div class="col-md-6 col-sm-6 col-xs-6">
            <?php if($catinfo['parentId']==0 || $catinfo['parentId']!=104) { ?>
            <h1><?php echo $catinfo['categoryName']; ?></h1>
            <?php } else { ?>
            <?php $imgname = $catinfo['categoryName'].'.jpg'; ?>
            <img style="height:36px; " src="<?php echo BASE_URL;?>static/images/brandstitleimage/<?php echo $imgname; ?>" class="img-responsive" alt="<?php echo $catinfo['categoryName']; ?>">
            <?php } ?>
          </div>
          <div class="col-md-6 col-sm-6 col-xs-6">
