                      ...
                      <div class="shpaddfrm">
                        <form class="shppadbdr" id="addressform" action="">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-12 col-lg-6 pl0 divstate"><div class="select-dd"><?php echo $helper->getSelectBox_state_To_cus_address('sel_state','1');    ?> 
                          ...
                          <?php if($_SESSION['Isguestcheckout']!="1" && $_SESSION['guestckout_sess_id']==""){ ?>
                          <div class="row mt30">
                            <div class="col-md-6 col-lg-3 pull-right pl0">
...
foreach($Paymentmethod as $value){ 
	  ...
	  ?>
                  ...
                  <div class="row ">
                    <div class="col-md-12 text-right mt30"> <span> <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" class="common-btn white-btn btn-block btn-lg back-button mr-2"> Back </a> </span> <span> <a class="common-btn btn-block btn-lg buynow-btn btnpaymentaddress"
												 role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree"> Proceed </a> </span> </div>
                  </div>
                </div>
              </div>
			...
			<div id="divordersummarytab">
				...
				-->
                  <div class="row mt30">
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12 text-right pt-3"> <span> <!--<a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree" class="common-btn white-btn btn-block btn-lg mr-2 back-button">-->
                    
                    <a class="common-btn btn-block btn-lg"
                     ...
                     Back </a> </span> <span> <a href="javascript:void();" class="common-btn btn-block btn-lg  paynowbtn"> Pay Now </a> </span> </div>
                  </div>
                </div>
              </div>
            </div>
