...
<div class="project-details-scroll">
        ...
        <?php	
								...
								?>
        <p> <a href="javascript:void(0)" style="min-width:100px;" class="common-btn mr-4 <?php echo $clsdisable; ?>" onClick="addtocart('<?php echo $productdetails['product_id'];?>')";>Add to Cart</a> <a style="min-width:100px;" href="javascript:void(0)" class="common-btn <?php echo $clsdisable; ?>" onClick="buynow('<?php echo $productdetails['product_id'];?>')";>Buy Now</a>
          <?php ELSE : ?>
...
<section class="features">
  <div class="tile" id="features-tab"> 
    ...
    <ul class="nav nav-tabs nav-justified" role="tablist">
      ...
      <li class="nav-item"> <a class="nav-link  show active" id="overview-tab" data-toggle="tab" href="#overview" role="tab" aria-controls="overview" aria-selected="true">Overview</a> </li>
      <?php }?>
      <?php if(count($getproductfeature) > 0){?>
      <li class="nav-item"> <a class="nav-link " id="features-tab" data-toggle="tab" href="#features" role="tab" aria-controls="features" aria-selected="true">Features</a> </li>
      <?php }?>
      <?php if(count(strip_tags($productattributes_video)) > 0){?>
    ...
    <div class="tab-content">
            ...
            <div class="col" data-aos="fade-right" data-aos-delay="50" data-aos-duration="1000">
              <div class="row justify-content-md-center">
                <div class="col-12 col-md-12 col-lg-10">
                  <div class="p-3"><?php echo $productdetails['longdescription'] ;?></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="tab-pane fade active" id="features" role="tabpanel" aria-labelledby="features-tab">
        <div class="container-fluid pl-0 pr-0">
          ...
          <div class="row no-gutters align-items-center">
            ...
            <div class="col-sm-12 col-md-6 col-lg-6 pt-5 pb-5 text-center"  data-aos="fade-left" data-aos-delay="100" data-aos-duration="1000">
          ...
          <?php }else{
						?>
          <div class="row no-gutters align-items-center">
            <div class="col-sm-12 col-md-6 col-lg-6 pt-5 pb-5 text-center"  data-aos="fade-right" data-aos-delay="100" data-aos-duration="1000">
...
<script>
$(".project-details-scroll").mCustomScrollbar({
    theme:"dark",
	setHeight: 100
});
</script>
