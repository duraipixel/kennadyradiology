  ...
  <div class="tab-content" id="myTabContent">
    ...
    <div class="tab-pane fade <?php echo ($k1 == 0) ? 'show active' : '';?>" id="hreftab-<?php echo $cat['categoryID'];?>" role="tabpanel" aria-labelledby="tab-<?php echo $cat['categoryID'];?>"> 
      ...
      <div class="your-class">
        ...
        <div>
          <?php if($imgs[0] != ''){?>
          <a href="<?php echo $helper->pathrevise($arrpath).'/'.$productlist['product_url']; ?>" > <img src="<?php echo BASE_URL;?>uploads/productassest/<?php echo $productlist['product_id']; ?>/photos/base/<?php echo $imgs[0]; ?>" alt=""></a>
          <?php }else{?>
          <a href="<?php echo $helper->pathrevise($arrpath).'/'.$productlist['product_url']; ?>" > <img src="<?php echo BASE_URL;?>uploads/noimage/photos/base/noimage.png" class="img-responsive center-block prdimg" title="<?php echo $p['product_name']; ?>" alt="<?php echo $p['product_name']; ?>" /></a>
          <?php }?>
