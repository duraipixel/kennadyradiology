 ...
 <script type="text/javascript" src="<?php echo BASE_URL; ?>static/js/jquery.simpleLens.js"></script>
  <script type="text/javascript" src="<?php echo BASE_URL; ?>static/js/mega-menu.js"></script>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.0/umd/popper.min.js" integrity="sha384-cs/chFZiN24E4KMATLdqdvsezGxaGsi4hLGOzlXwp5UZB1LY//20VyM2taTB4QvJ" crossorigin="anonymous"></script>
 <script type="text/javascript" src="<?php echo BASE_URL; ?>static/multiselect/BsMultiSelect.js"></script>
  <script type="text/javascript">
    $("#filter1, #filter2").bsMultiSelect({cssPatch : {
                   choices: {columnCount:'1' },
                }});
  </script>
  
  <script src="https://d3js.org/d3.v5.min.js"></script>
  <script type="text/javascript" src="<?php echo BASE_URL; ?>static/js/d3RangeSlider.js"></script>
