                          ...
                          <div class="row">
                            ...
                            <?php										 
										  if($val["attribute_type"] == "dropdown" ||  $val["attribute_type"] == "radio" ){
											...
											?>
                            <div class="col-sm-7" id="<?php echo  str_replace(")","",str_replace("(","",str_replace(" ","_",$val["attributename"]))); ?>">
                              <select class="select2 form-control seldrps seldrp<?php echo $val["attributeid"]; ?>" id="customattrib_<?php echo $val["attribute_type"] ?>_<?php echo  $val["attributeid"]; ?>" onchange="return makecheckboxselect(<?php echo  $val["attributeid"]; ?>)" multiple="multiple" name= "customatt[]">
                                <option value=''>--Select--</option>
                                <?php  
														foreach($resDropdown as $dropdownVal){
														$sel="";
                            ...
                            <div class="n-chk">
                              <label class="new-control new-checkbox checkbox-success">
                                <input type="checkbox" data-id="<?php echo  $val["attributeid"]; ?>"  class="new-control-input selchks selchk<?php echo $val["attributeid"]; ?>" id="checbox_<?php echo $counter; ?>" name="chkpvatt"  value="<?php echo  str_replace(")","",str_replace("(","",str_replace(" ","_",$val["attributename"]))); ?>"   <?php echo $chkpvatts; ?>>
                                <span class="new-control-indicator"></span>&nbsp; </label>
                            </div>
							
							<div class="n-chk">
                              <label class="new-control new-checkbox checkbox-success">
                                <input type="checkbox"  class="new-control-input selchkprice<?php echo $val["attributeid"]; ?> selchkprice" id="checboxprice_<?php echo $counter; ?>" name="chkpvattprice"  value="<?php echo  str_replace(")","",str_replace("(","",str_replace(" ","_",$val["attributename"]))); ?>"   <?php echo $chkpvatts; ?>>
                                <span class="new-control-indicator"></span>&nbsp; </label>
                            </div>
	...
	*/
	...
	$("#generateCombination").click(function(){
		 ...
		 for(a=b;a>0;a--){
			if(a == b){
				...
				for(h=1;h<=b;h++){
					...
					w += ' $("#combinationCollection").append( \'<span class="combination1">\'+combiArr_price'+h+'[var'+h+']+" "+\' </span>\' ); ';					
				}
				...
				w += ' $("#combinationCollection").append( \' <span class="combinationsub">Price  </span> <input type="text"  class=" combinationnput" name="combiprice_\'+temp_pricestr+\'" id="combiprice_\'+temp_pricestr+\'"  /> \' ); ';
				w += ' $("#combinationCollection").append( \' <span class="combinationsub">Sku </span> <input type="text" class=" combinationnput" name="combisku_\'+temp_pricestr+\'" id="combisku_\'+temp_pricestr+\'" /> \' ); ';							
				
				w += ' $("#combinationCollection").append( \' <span class="combinationradio">IsDefault</span> <input type="radio" class="" name="combiIsDefault" value="\'+temp_pricestr+\'"  />   \' ); ';
				w += ' $("#combinationCollection").append( \' <a style="margin-left:5px;"class="remove_front" href="javascript:void(0);" class="removeAttr" ><i class="fa fa-trash-o"></i> Remove</a>  \' ); ';
		...
		$('#combinationCollection label').each(function(){	
		   ...
		   $(this).nextUntil('label').wrapAll('<div class="combinationresult row col-md-12" id="attrCollection_'+counter1+'" />');
		   counter1++;
		});
