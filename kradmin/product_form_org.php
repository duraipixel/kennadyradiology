                        ...
                        <fieldset id="attributeCollection">
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-7" id="<?php echo  str_replace(")","",str_replace("(","",str_replace(" ","_",$val["attributename"]))); ?>">
                              <select  onchange="return makecheckboxselect(<?php echo  $val["attributeid"]; ?>)" class="select2 form-control seldrps seldrp<?php echo $val["attributeid"]; ?>" id="customattrib_<?php echo $val["attribute_type"] ?>_<?php echo  $val["attributeid"]; ?>" multiple="multiple" name= "customatt[]">
                                <option value=''>--Select--</option>
                                <?php  
														foreach($resDropdown as $dropdownVal){
														$sel="";
