...
$mdme = getMdmeOrderproductReport($db,'');
    ...
    <div class="container">
      <div class="page-header">
        <div class="page-title">
          <h3>Purchased Products Report</h3>
          <div class="crumbs">
            <ul id="breadcrumbs" class="breadcrumb">
              <li><a href="dashboard.php"><i class="flaticon-home-fill"></i></a></li>
              <li><a href="#">Reports</a></li>
              <li class="active"><a href="#">Purchased Products Report</a> </li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-12">
          <div class="statbox widget box box-shadow">
            <div class="widget-header">
              <div class="row">
                <div class="col-md-8">
                  <h4>Purchased Products Report</h4>
                </div>
            ...
            <div class="widget-content widget-content-area">
              ...
              <div class="table-responsive mb-4">
                <input type="hidden" name="disptblname" id="disptblname" value="<?php echo "orderproducts"; ?>" />
...
$(document).ready(function($){
	...
	var url = "orderproducts_downloads.php" 
