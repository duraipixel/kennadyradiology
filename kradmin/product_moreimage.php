      ...
      <div class="row">
        <div class="col-lg-12 layout-spacing">
          <div class="statbox widget box box-shadow">
            ...
            <div class="widget-content widget-content-area">
              <div class="row">
                <div class="col-md-8 mx-auto">
                  <form id="jvalidate" name="frmProductimage" role="form" class="form-horizontal" action="#" method="post" enctype='multipart/form-data' >
                          ...
                          <div class="col-sm-9 mb-4">
                            <div class="form-upload product_img">
                              <div class="dropzone" id="dropzone">
                                <input class="product_images" id="productimage" required name="productimage[]" type="file" fi-type="" multiple="multiple" >
                              </div>
            ...
            <fieldset>
    	        <legend></legend>    
                <form class="form-horizontal" action="product_actions.php" id="jvalidate1" name="noimg" method="post" >
                    ...
                    <tr class="odd gradeX">
                            ...
                            <td><?php echo $getimg['dropdown_values'];?></td>
                             <td>
								 ...
								 ?>
			                      <img  width="50"  src="<?php echo IMG_BASE_URL."productassest/".$view."/photos/".$getimg['img_path']; ?>" /> 
            	                <?php }?>
                             </td>
                             <td> 
                           		<input type="hidden" name="productimgid" id="productimgid<?php echo $getimg['product_img_id'];?>" value="<?php echo $getimg1['product_img_id'];?>" />
                                <input type="text"   maxlength="3" onkeypress="return CheckNumericKeyInfowithoutDot(event.keyCode, event.which);" name="image1order<?php echo $getimg['product_img_id'];?>" id="image1order<?php echo $getimg['product_img_id'];?>" placeholder="Image Sort order" class="form-control" value="<?=$getimg['ordering']?>"  />
                             </td>                                            
                            
                            <td align="center">
                              <input name="status<?php echo $getimg['product_img_id'];?>" <?php if($getimg['IsActive']==1){echo $check="checked";} ?> id="modules-<?php echo $getimg['product_img_id'];?>" value="1" type="checkbox">
                              <input type="hidden" name="image<?php echo $getimg['product_img_id'];?>id" id="image<?php echo $getimg['product_img_id'];?>id" placeholder="Image Sort order" class="form-control" value="<?=$getimg['product_img_id']?>" />
                            </td>
                            
                            
                          <td class="center">   
                             <input  class='product_image_del'  name="imagestatus<?php echo $getimg['product_img_id'];?>" <?php echo $imgcheck; ?> id="modules-<?php echo $getimg['product_img_id'];?>" value="1" type="checkbox">
                             <input type="hidden" name="productim<?php echo $getimg['product_img_id'];?>" value="<?php echo $getimg['img_path']; ?>" />
                             <input name="img_path<?php echo $getimg['product_img_id'];?>" value="<?php echo root; ?>uploads/news/<?php echo $getimg['img_path']; ?>" type="hidden">                    
                          </td>
                       </tr>                    
                    <?php $j++;}?>                                           
                    <?php
          ...
          <?php if($countgetimages > 0){?>
            <div class="form-group">
              ...
              <div class="col-lg-3">
                   <button class="btn bg-purple margin" type="reset" onClick="javascript:funCancel('noimg','jvalidate1','moreimageupdate','product_mng.php');" >Cancel</button>
       <!-- <input type="submit" class="btn bg-maroon margin pull-right" value="Update" />-->
                <button class="btn bg-maroon margin pull-right" type="button" onClick="javascript:funSubmt('noimg','product_actions.php','jvalidate1','moreimageupdate','product_moreimage.php?id=<?php echo $view;?>');" >
