 ...
 <?php		
                        ...
                        <fieldset id="attributeCollection">
                          ...
                          <div class="row">
                            ...
                            <div class="n-chk">
                              <label class="new-control new-checkbox checkbox-success">
                                <input type="checkbox" data-id="<?php echo  $val["attributeid"]; ?>"  class="new-control-input selchks selchk<?php echo $val["attributeid"]; ?>" id="checbox_<?php echo $counter; ?>" name="chkpvatt[]"  value="<?php echo  $val["attributeid"]; ?>"   <?php echo $chkpvatts; ?>>
                                <span class="new-control-indicator"></span>&nbsp; </label>
                            </div>
							
							<div class="n-chk">
                              <label class="new-control new-checkbox checkbox-success">
                                <input type="checkbox"  class="new-control-input selchkprice<?php echo $val["attributeid"]; ?> selchkprice" id="checboxprice_<?php echo $counter; ?>" name="chkpvattprice[]"  value="<?php echo $val['attributeid'];//echo  str_replace(")","",str_replace("(","",str_replace(" ","_",$val["attributename"]))); ?>" <?php if(in_array($val['attributeid'],explode(',',$res_ed['chkpvattprice_id']))){?>checked='checked'<?php }?> <?php //echo $chkpvattsprice; ?>>
                                <span class="new-control-indicator"></span>&nbsp; </label>
                            </div>
                        ...
                        <blockquote class="blockquote">
						  ...
						  <input type="radio" class="" name="combiIsDefaultid_<?php echo $val['attributeId'] ?>_<?php echo $issingle;?>" <?php echo ($val['isDefault'] == 1)?  "checked='checked' ":""; ?> value="<?php echo $val['attr_combi_id'] ?>_"> 
						  
						  
 <input type="checkbox" class="" name="combiIssold_<?php echo $val['attr_combi_id'] ?>" <?php echo ($val['outofstock'] == 1)?  "checked='checked' ":""; ?> value="<?php echo $val['attr_combi_id'] ?>"> Is Sold out
 </div>
