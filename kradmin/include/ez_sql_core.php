<?php
	...
	*/
	...
	public function get_a_line_bind($query=null, $param=null,$output = ARRAY_A,$y=0)
	{
			
			//$this->query_prepared('SELECT * FROM gps_banners WHERE bannerid in (?,?) ',[1,2] );
			...
			if ( $query )
			{
				...
				if($param!=null){
					...
					// print_r($query);
				$this->query_prepared($query,$param);
	...
	public function get_a_line_bind2($query=null, $param=null,$output = ARRAY_A,$y=0)
	{
			...
			if ( $query )
			{
				...
				if($param!=null){
					 print_r($query);
				$this->query_prepared2($query,$param);
				//$this->pdo->query($query);
	...
	function get_rsltset_bind($query=null, $param=null,$output = ARRAY_A)
	{
			...
			if ( $query )
			{
				...
				$this->query_prepared($query,$param);
				//$this->pdo->query($query);
				//$this->pdo->query_prepared('SELECT * FROM kesar_banners WHERE bannerid in (?,?) ',[1,2] );
				//$result = $this->pdo->last_result;
				//print_r($result );
	...
	function get_rsltset_bind2($query=null, $param=null,$output = ARRAY_A)
	{
                ...
                // If insert operation
                   ...
                   //  echo "select * from $table $wc"; die();
                            ...
                            if($check_dup_qry>0)  //If duplicate row exists
                            {
                              ...
                              //   echo "<pre>";                                 print_r($sp); exit;
                                   ...
                                   $rr[trim($sp[0])]=  str_replace ("'", "", $sp[1]);
                                    ...
                                    $operation="update";
                                    $str="insert into ".TPLPrefix."userlog(UserId,Username,Type,Id,ColName,Operation,OldValue,NewValue,Module,Comment,LoggedDate)values('$user_id','$user_name','$table','$id','$db_col_up','$operation','$old_db_val','$db_col_new_val','$module','$comments','$logge_date')";
                       ...
                       // preg_match_all("^\((.*?)\)^",$second[0],$fields);
                        ...
                        $str="insert into ".TPLPrefix."userlog(user_id,Username,Type,Id,ColName,Operation,OldValue,NewValue,Module,Comment,LoggedDate)values('$user_id','$user_name','$table','$id','$db_col','$operation','','$db_colum_val','$module','$comments','$logge_date')";
                    ...
                    else if (strpos(strtolower($query),'values') !== false)
                    {
                        ...
                        if (strpos(strtolower($clear_val),'),(') !== false)
                        {
                           ...
                           foreach ($fields[1] as $ins_val)
                           {
								...
								$db_col_val_mul=getRealescape($db_col_val_mul);
                                 ...
                                 $str="insert into ".TPLPrefix."userlog(UserId,Username,Type,Id,ColName,Operation,OldValue,NewValue,Module,Comment,LoggedDate)values('$user_id','$user_name','$table','$id','$db_col','$operation','','$db_col_val_mul','$module','$comments','$logge_date')";
                      ...
                      else
                      {
                          ...
                          //  $db_colum_val = str_replace("'", "", $db_col_val);
                            ...
                            $str="insert into ".TPLPrefix."userlog(UserId,Username,Type,Id,ColName,Operation,OldValue,NewValue,Module,Comment,LoggedDate)values('$user_id','$user_name','$table','$id','$db_col','$operation','','$db_colum_val','$module','$comments','$logge_date')";
           ...
           if(count($res_val)>0)
           {
               ...
               for($v=0;$v<count($res_val);$v++)
               {
                 ...
                 //  echo $db_col_new_value."<br>";
                   $str="insert into ".TPLPrefix."userlog(UserId,Username,Type,Id,ColName,Operation,OldValue,NewValue,Module,Comment,LoggedDate)values('$user_id','$user_name','$table','$id','$db_col','$operation','','$db_col_new_value','$module','$comments','$logge_date')";
           ...
           if(count($res_old)>0)
           {
               for($v=0;$v<count($res_old);$v++)
               {
                 ...
                 //  echo $db_col_old_value."<br>";
                   $str="insert into ".TPLPrefix."userlog(UserId,Username,Type,Id,ColName,Operation,OldValue,NewValue,Module,Comment,LoggedDate)values('$user_id','$user_name','$table','$id','$db_column','$operation','$db_col_old_value','$db_column_new','$module','$comments','$logge_date')";
              ...
              //   echo $db_column_val_update."---".$db_column;
					  ...
					  $db_column_val_update=getRealescape($db_column_val_update);
                             ...
                             //  echo $db_col_old_value."<br>"; exit;
                                $str="insert into ".TPLPrefix."userlog(UserId,Username,Type,Id,ColName,Operation,OldValue,NewValue,Module,Comment,LoggedDate)values('$user_id','$user_name','$table','$id','$db_column','$operation','$db_col_old_value','$db_column_val_update','$module','$comments','$logge_date')";
                      ...
                      //  echo "<pre>"; print_r($res_old);
                            ...
                            if(count($res_old)>0)
                            {
                                ...
                                for($v=0;$v<count($res_old);$v++)
                                {
                                   ...
                                   // echo $db_col_old_value."<br>";
                                    $str="insert into ".TPLPrefix."userlog(UserId,Username,Type,Id,ColName,Operation,OldValue,NewValue,Module,Comment,LoggedDate)values('$user_id','$user_name','$table','$id','$ass_col','$operation','$db_col_old_value','','$module','$comments','$logge_date')";
                                   // echo $str; exit;
