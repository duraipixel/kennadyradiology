          ...
          <div class="statbox widget box box-shadow">
            ...
            <div class="widget-content widget-content-area">
              ...
              <div class="table-responsive mb-4">
                <input type="hidden" name="disptblname" id="disptblname" value="<?php echo "payments"; ?>" />
...
<div class="modal fade beacon-modal" id="payment_status_modal"  role="dialog" aria-hidden="true">
...
-->
 ...
 function update_payment_status(status_id,order_id){
    
     if(status_id=='37'){
        var $modal = $('#payment_status_modal');	
        $modal.load('payment_status_change.php',{'status_id':status_id,'order_id':order_id},
        function(){  
        $modal.modal('show'); 
        ...
        if (result.value) {
            ...
            var m_data = 'action=changePaymentStatus&order_id='+order_id+'&status_id='+status_id;
            $.ajax({
                ...
                success: function(response){ 
                    if(response.rslt=='1'){
                        ...
                        paymentmailfunction(order_id,status_id);
                    }
...
function updatepaymentstatus(status_id,order_id){
    var ref='';
    if(status_id){
        ref = '&txtTrnasactionid='+$("#txtTrnasactionid").val();
    }
    
    var m_data = 'action=changePaymentStatus&order_id='+order_id+'&status_id='+status_id+ref;
            $.ajax({
                url        : 'orders_actions.php',
                method     : 'POST',
                dataType   : 'json',
...
function paymentmailfunction(orderId,status_id){     	
	$.ajax({
		url:'<?php echo BASE_URL;?>ajaxresponse.php',
		data :{action:"paymentmailsend",order_id:orderId,status_id:status_id},
		method     : 'POST',
		dataType   : 'json',			
	})
