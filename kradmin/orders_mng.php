                        ...
                        <div class="widget-content widget-content-area">
                            <form class="form-horizontal form-val-1" id="productList" name="frmState" action="#"
                                ...
                                <div class="row col-sm-12">
                                    ...
                                    <div class="col-sm-4">
                                        <input class="pFilters form-control" type="text" name="orders_name"
                                            id="orders_name" />
                                    </div>
                                ...
                                <div class="row col-sm-12">
                                    ...
                                    <div class="col-sm-4">
                                        <select class=" form-control" id="status" name="status">
                                            ...
                                            <option value="<?php echo $stval['order_statusId']; ?>">
                                                <?php echo $stval['order_statusName']; ?></option>
                                            <?php }  ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-sm-2">
                                        <div class="input-control text " data-role="datepicker"
                                            ...
                                            <input type="text" placeholder="From" name="dateFrom" id="dateFrom"
                                                readonly>
                            ...
                            <div class="table-responsive mb-4">
                                <input type="hidden" name="disptblname" id="disptblname"
...
<div class="modal fade" id="changedstatuscomment" tabindex="-1" role="dialog" aria-labelledby="changedstatus"
    aria-hidden="true">
...
function update_order_status(status_id, order_id) {
    ...
    if (status_id == '3' || status_id == '5' || status_id == '14') {
        ...
        $modal.load('order_status_change.php', {
                'status_id': status_id,
                'order_id': order_id
            },
            function() {
