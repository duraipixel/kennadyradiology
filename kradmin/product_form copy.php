                            ...
                            <div class="col col col-md-6">
                              <div class="control-group mb-4">
                                ...
                                <div id="newprodfromtodate" style='<?php echo $isnewproduct!="" ? "display:block": "display:none"; ?>'>
                                  <div class="row">
                                    <div class="col-sm-4 no-padding-left">
                                      <input type="text" placeholder="From" class="form-control calldatepicker  sdate_today_min" name="newprod_fromdate" id="newprod_fromdate" value="<?php echo $res_ed['newprod_fromdate']!='' && strtotime($res_ed['newprod_fromdate'])!='0'?  date('d-m-Y',strtotime($res_ed['newprod_fromdate'])): date('d-m-Y'); ?>" readonly	>
                                    </div>
                                    <div class="col-sm-4 no-padding-left">
                                      <inputtype="text" placeholder="To" class="form-control calldatepicker  edate_today_min" name="newprod_todate" id="newprod_todate" value="<?php echo $res_ed['newprod_todate']!='' && strtotime($res_ed['newprod_fromdate'])!='0' ?  date('d-m-Y',strtotime($res_ed['newprod_todate'])): date($GLOBALS['stroedateformat']['phpformat']); ?>" readonly               >
                                    </div>
                                  </div>
                                </div>
                              </div>
