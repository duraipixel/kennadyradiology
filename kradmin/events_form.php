        ...
        <div class="page-title">
          ...
          <div class="crumbs">
            <ul id="breadcrumbs" class="breadcrumb">
              ...
              <li><a href="events_mng.php">Events</a></li>
              <li class="active"><a href="#"><?php echo $operation; ?> Events</a> </li>
            </ul>
          </div>
        </div>
      </div>
            ...
            <div class="widget-header">
              <div class="row">
                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                  <h4><?php echo $operation; ?> Events</h4>
                </div>
              </div>
            </div>
                ...
                <div class="col-md-8 mx-auto">
                  <form class="form-horizontal form-val-1" id="jvalidate" name="menu-form" action="#" novalidate="">
                    ...
                    <div class="row">
                      <div class="col col col-md-3">
                        <div class="control-group mb-4">
                          <label class="control-label">Events Title  <span class="required-class">* </span></label>
                        </div>
                      </div>
					...
					<div class="row">
                      <div class="col col col-md-3">
                        <div class="control-group mb-4">
                          <label class="control-label"><?php echo Spanish; ?>  Events Title <span class="required-class">* </span></label>
                        </div>
                      </div>
                      <div class="col col col-md-6">
                        <div class="control-group mb-4">
					...
					<div class="row">
                      <div class="col col col-md-3">
                        <div class="control-group mb-4">
                          <label class="control-label"><?php echo Portuguese; ?> Events Title <span class="required-class">* </span></label>
                        </div>
                      </div>
                      <div class="col col col-md-6">
                        <div class="control-group mb-4">
                          ...
                          <div class="controls">
                           <!--<input type="text" class="form-control" required name="txteventdate" id="txteventdate" value="<?php echo $res_ed['eventdate']; ?>"  />
                            ...
                            <div class="input-control text" data-role="datepicker"   data-format="dd-mm-yyyy">
                              <input type="text" placeholder="Events Date" name="txteventdate" id="txteventdate"   value="<?php echo $res_ed['eventdate']!=''? date($GLOBALS['stroedateformat']['phpformat'],strtotime($res_ed['eventdate'])): date($GLOBALS['eventdate']['phpformat']); ?>" readonly required>
                  ...
                  Add Embed Link 
                    ...
                    <div class="row fls-eat" id="videosurl" style="display:none;">
                      <div class="col col-md-3">
                        <div class="control-group mb-4">
                          <label class="control-label">Events URL</label>
                        </div>
                      </div>
                      <div class="col col-md-6">
                        <div class="control-group mb-4">
                  ...
                  <span class="">Include(http://)</span>
                    ...
                    <div class="row fls-eat" id="videosurl_es" style="display:none;">
                      <div class="col col-md-3">
                        <div class="control-group mb-4">
                          <label class="control-label"> <?php echo Spanish; ?> Events URL</label>
                        </div>
                      </div>
                      <div class="col col-md-6">
                        <div class="control-group mb-4">
                  ...
                  <span class="">Include(http://)</span>
                    ...
                    <div class="row fls-eat" id="videosurl_pt" style="display:none;">
                      <div class="col col-md-3">
                        <div class="control-group mb-4">
                          <label class="control-label"><?php echo Portuguese; ?> Events URL</label>
                        </div>
                      </div>
                      <div class="col col-md-6">
                        <div class="control-group mb-4">
