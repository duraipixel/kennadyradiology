...
switch ($_REQUEST['finaltab']){ 			
	...
	case "featurestories":		
		$dispFields = array("row_number","StoryTitle","StoryDescription","StoryDate","StoryURL");
		$disporder_ID= "FsId";
...
case "shippingflatair":		
	...
	break;
		...
		$wrcon .= " and (s.emailid like '%".$requestData['search']['value']."%' or l.languagename like '%".$requestData['search']['value']."%')";	
	...
	case "testimonial":	    		 
		$dispFields = array("row_number","customername","customeremailid","testimonialcontent","languagefrom");
		$disporder_ID= "testimonialid";
		$mdme = getMdmeTestimonial($db,''); 	
		$statuscheck = checkIsactive('',$requestData['search']['value']);	
		
        $wrcon = " and (t.customername like '%".$requestData['search']['value']."%' or t.customeremailid like '%".$requestData['search']['value']."%' or l.languagename like '%".$requestData['search']['value']."%' $statuscheck )";		
...
}else if($_REQUEST['finaltab'] == 'testimonial' || $_REQUEST['finaltab'] == 'subscribe'){
	$edtstat='';
}else{
