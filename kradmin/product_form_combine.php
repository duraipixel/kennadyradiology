 ...
 <?php		
                        ...
                        <fieldset id="attributeCollection">
                          ...
                          <div class="row">
							...
							<div class="n-chk">
                              <label class="new-control new-checkbox checkbox-success">
                                <input type="checkbox"  class="new-control-input selchkprice<?php echo $val["attributeid"]; ?> selchkprice" id="checboxprice_<?php echo $counter; ?>" name="chkpvattprice"  value="<?php echo  str_replace(")","",str_replace("(","",str_replace(" ","_",$val["attributename"]))); ?>"   <?php echo $chkpvattsprice; ?>>
                                <span class="new-control-indicator"></span>&nbsp; </label>
                            </div>
