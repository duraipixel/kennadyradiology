...
if(isset($_FILES) && sizeof($_FILES) > 0) {
	...
	function prodattrchange()
	{
		...
		if($productdetails['attr_combi_id']!='') {	
			...
			$template3->set('productdetails',$productdetails);	
			...
			echo json_encode(array("rslt"=>$pricedetails,"changeimg"=>$imgdetails,"filter_content"=>$filter_content,"status"=>200,"product_sku"=>$productdetails['sku'],"product_price"=>$productfilter[0]['price']));	
		}else{
