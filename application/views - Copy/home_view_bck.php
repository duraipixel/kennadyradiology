      ...
      <div class="slider silder-left slider-nav">
        ...
        <div>
          <div class="acces-wrap">
            <?php if($imgs[0] != ''){?>
            <a href="<?php  echo $helper->pathrevise($arrpath).'/'.$homeproductimg['product_url']; ?>" > <img src="<?php echo img_base;?>uploads/productassest/<?php echo $homeproductimg['product_id']; ?>/photos/<?php echo $imgs[0]; ?>" alt=""></a>
            <?php }else{?>
            <a href="<?php  echo $helper->pathrevise($arrpath).'/'.$homeproductimg['product_url']; ?>" > <img src="<?php echo img_base;?>uploads/noimage/photos/medium/noimage.png" class="img-responsive center-block prdimg" title="<?php echo $homeproductimg['product_name']; ?>" alt="<?php echo $homeproductimg['product_name']; ?>" /></a>
            <?php }?>
          </div>
        </div>
        <?php }?>
				...
				<div class="video-slider">
					<div>
						<div class="sell-wrap ">
							...
							<img src="<?php echo img_base;?>static/images/play-icon.png" alt="" />
							<img class="video-placeholder" src="<?php echo img_base;?>static/images/video-bg-1.jpg" alt="" />
					...
					<div>
						<div class="sell-wrap">
							...
							<img src="<?php echo img_base;?>static/images/play-icon.png" alt="" />
							<img class="video-placeholder" src="<?php echo img_base;?>static/images/video-bg-2.jpg" alt="" />
					...
					<div>
                        ...
                        <div class="playvideo3" id="playvideo3">
							<img src="<?php echo img_base;?>static/images/play-icon.png" alt="" />
							<img class="video-placeholder" src="<?php echo img_base;?>static/images/video-bg-3.jpg" alt="" />
