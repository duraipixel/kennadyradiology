									...
									?>	
										...
										// if($cimgpath != ''){
										 ?>
										 	...
										 	<!--<a data-fancybox="gallery<?php echo $cnt; ?>" href="<?php echo img_base;?>uploads/productassest/<?php echo $productlist['product_id']; ?>/photos/<?php echo  $cimgpath; ?>" alt="<?php echo $productlist['product_name']; ?>" class="prdsingle-inner">	
											<span class="cartproimg">
								         
								          		<img  src="<?php echo img_base;?>uploads/productassest/<?php echo $productlist['product_id']; ?>/photos/<?php echo  $cimgpath; ?>" alt="<?php echo $productlist['product_name']; ?>" class="img-responsive">
										 ...
										 ?>
                                            ...
                                            <span class="cartproimg">
								          		...
								          		<img  src="<?php echo img_base;?>uploads/noimage/photos/thumb/noimage.png" alt="<?php echo $productlist['product_name']; ?>" class="img-responsive">
