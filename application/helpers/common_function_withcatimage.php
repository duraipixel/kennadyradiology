			   ...
			   case "3":
							...
							if(count($subcat)>0)
							{
								...
								$subhtml='<ul style="display: none; opacity: 1;">
											...
											<a href="#" class="d-none">Sub Category</a>
      <ul>
        <li><a href="'.BASE_URL.$catinfo['categoryCode'].'"> <img src="'.$catimg.'" class="img-fluid" alt=""> </a> </li>
		</ul>
												';
														if($catinfo['categoryCode'] != ''){
								$menulink='<a class="" href="'.BASE_URL.$catinfo['categoryCode'].'" >';
														}else{
								$menulink='<a class="" href="'.BASE_URL.'products">';
														}
								foreach($subcat as $sub)
								{
									$baseimgurl=BASE_URL.'static/images/noimage.jpg'; 
											 ...
											 if($sub['categorymenuimage'] != ''){
												  $subhtml.='<li><a href="'.BASE_URL.'products'.$catinfo['categoryCode'].'/'.$sub['categoryCode'].'">'.$sub['categoryName'].' <img src="'.img_base_url.'category/categorymenuimage/'.$sub['categorymenuimage'].'" class="img-fluid" alt=""></a></li>';
											 }else{
												 $subhtml.='<li><a href="'.BASE_URL.'products'.$catinfo['categoryCode'].'/'.$sub['categoryCode'].'">'.$sub['categoryName'].'</a></li>'; 
											 }
									...
									{   $subhtml.='<ul class="customdropdown">';
										foreach($subcatplus as $plus)
										{
											 ...
											 if($plus['catimage']!=''){
											  ...
											  if($sub['categorymenuimage'] != ''){
											$subhtml.='<li>
											<a href="'.BASE_URL.$catinfo['categoryCode'].''.$sub['categoryCode'].'/'.$plus['categoryCode'].'"> <img src="'.img_base_url.'category/categorymenuimage/'.$sub['categorymenuimage'].'" class="img-fluid" alt=""> </a> 
											
														 
														</li>';
											  }else{
												  $subhtml.='<li>
											<a href="'.BASE_URL.$catinfo['categoryCode'].''.$sub['categoryCode'].'/'.$plus['categoryCode'].'"> </a> 
