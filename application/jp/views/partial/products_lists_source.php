						...
						<div class="prdimginner-slider carousel-inner" role="listbox">
						   <?php 
							...
							<div class="item <?php echo $ind==0? 'active' :''; ?> prdimginner">
								<img src="<?php echo img_base;?>uploads/productassest/<?php echo $p['product_id']; ?>/photos/medium/<?php echo $i; ?>" class="img-responsive center-block prdimg prtz" title="<?php echo $p['product_name']; ?>" alt="<?php echo $p['product_name']; ?>" />
							</div>
								<?php $ind++; } } else {  ?>	
								<div class="item <?php echo $ind==0? 'active' :''; ?> prdimginner">
								<img src="<?php echo img_base;?>uploads/noimage/photos/medium/noimage.png" class="img-responsive center-block prdimg prtz" title="<?php echo $p['product_name']; ?>" alt="<?php echo $p['product_name']; ?>" />
							</div>
								<?php  } ?>
						</div>
						<?php }  else {  ?>	
