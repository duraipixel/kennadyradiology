								    ...
								    <table cellpadding="0" cellspacing="0" border="0">
								      <tbody>
								        ...
								        <tr>
										 ...
										 <img src="<?php echo img_base;?>uploads/finalcustomimg/<?php echo $cartlist['CustomtoolImg']; ?>" alt="<?php echo $cartlist['product_name']; ?>">
										 </span>
										  </a>
										 <span class="tblimg-details">
												...
												<a data-fancybox="gallery<?php echo $cnt; ?>"  href="<?php echo img_base;?>uploads/finalcustomimg/<?php echo $cartlist['CustomtoolImg']; ?>" class="viewcustom">View Customized</a>
												<?php echo $strAttr; ?>
										 ...
										 <?php } else { ?>
										  ...
										  <span class="cartproimg">
								          		...
								          		<img src="<?php echo img_base;?>uploads/productassest/<?php echo $cartlist['product_id']; ?>/photos/<?php echo  $imgpath; ?>" alt="<?php echo $cartlist['product_name']; ?>">
										 ...
										 <?php } ?>	
								          ...
								          <td><i class="fa fa-inr"></i> <?php echo number_format($cartlist['finaldiscountamt'],2); ?> </td>
