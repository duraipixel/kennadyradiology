         ...
         <div class="container">
            <ul class="brand-list">
              ...
              <li>
                 ...
                 <img src="<?php echo img_base;?>uploads/mcimage/<?php echo $barndtieuplogo['mcimage']; ?>"  alt=""> 
                  </a>
               </li>
               ...
               <div class="inthePress-slider">
                  <?php foreach($getourclientslogo as $barndtieuplogo){ ?>
                   <div class="sell-wrap press-logos">
                      <a href="<?php echo $barndtieuplogo['mcurl']; ?>"  target="_balnk"> <img src="<?php echo img_base;?>uploads/mcimage/<?php echo $barndtieuplogo['mcimage']; ?>"  alt=""> </a>
                   </div>
                      <?php }?>
               </div>
            </div>
