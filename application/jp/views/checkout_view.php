            ...
            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-mdb-parent="#accordionCheckout">
              <div class="accordion-body">
                <div class="row">
                  ...
                  <div  id="addresslist" class="addresslist-wper row">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                      <div class="delivery-address <?php echo (isset($_SESSION['addressid']) && $_SESSION['addressid']==$displayaddress['cus_addressid'])? "   " :''; ?>">
                ...
                <?php if(isset($_SESSION['shippincode']) || $_SESSION['shippincode']!='' ){	
									...
									?>
                <div class="show-address" style="<?php echo $clsdis;?>">
                  ...
                  <form class="shppadbdr" id="addressform" action="">
                    ...
                    <div class="row">
                      <div class="col-sm-12 col-md-6 col-lg-4">
                        ...
                        <input type="text" class="form-control" id="firstname" name="firstname" placeholder="<?php echo $formdisplaylanguage['firstname'];?>" required=''>
                      </div>
                      <div class="col-sm-12 col-md-6 col-lg-4">
                        <input type="text" class="form-control" id="lastname" name="lastname" placeholder="<?php echo $formdisplaylanguage['lastname'];?>" required=''>
                      </div>
                      <div class="col-sm-12 col-md-6 col-lg-4">
                        <input type="email" class="form-control" id="email" name="email" placeholder="<?php echo $formdisplaylanguage['emailaddress'];?>" required=''>
                      </div>
                      <div class="col-sm-12 col-md-6 col-lg-4">
                      ...
                      <div class="col-sm-12 col-md-12 col-lg-12 text-center res-pad-top">
                        <button onclick="javascript:Addressform('frmaddress','<?php echo BASE_URL; ?>ajax/Addressform','addressform','Address','<?php echo BASE_URL; ?>checkout');" type="button" class="buy-now-btn1" data-mdb-toggle="collapse" data-mdb-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo"> <?php echo $formdisplaylanguage['saveupdate'];?> </button>
                      </div>
                      <?php } else { ?>
                      <div class="col-sm-12 col-md-12 col-lg-12 text-center res-pad-top"> 
              ...
              <div class="col-sm-12 col-md-12 col-lg-12 text-right pb-3 pt-3">
                <button type="button" class="buy-now-btn1 mr-0 collapsed" data-mdb-toggle="collapse" data-mdb-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"> <?php echo $checkoutdisplaylanguage['proceed'];?> </button>
...
-->
                      ...
                      <button type="button" class="add-to-cart-btn1 mr-3 collapsed" data-mdb-toggle="collapse" data-mdb-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne"> <?php echo $commondisplaylanguage['back'];?> </button>
...
foreach($Paymentmethod as $value){ 
	  ...
	  ?>
                  ...
                  <div class="col-sm-12 col-md-12 col-lg-12 text-right res-pad-top">
                    <button type="button" class="add-to-cart-btn1 mr-3 collapsed" data-mdb-toggle="collapse" data-mdb-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"> <?php echo $commondisplaylanguage['back'];?> </button>
