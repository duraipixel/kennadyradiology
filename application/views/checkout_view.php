...
foreach($Paymentmethod as $value){ 
	  ...
	  ?>
                  ...
                  <div class="col-sm-12 col-md-6 col-lg-6 text-right res-pad-top">
                    <button type="button" class="add-to-cart-btn1 mr-0 collapsed" data-mdb-toggle="collapse" data-mdb-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"> <?php echo $commondisplaylanguage['back'];?> </button>
