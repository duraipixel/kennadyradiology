...
<html lang="en">
  <head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo img_base; ?>/static/css/flaticon.css">
	<link rel="stylesheet" type="text/css" href="<?php echo img_base; ?>/static/css/product-zoom.css">
	<link rel="stylesheet" type="text/css" href="<?php echo img_base; ?>/static/css/basictable.min.css">
	<link rel="stylesheet" type="text/css" href="<?php echo img_base; ?>/static/css/header.css">
    <link rel="stylesheet" type="text/css" href="<?php echo img_base; ?>/static/css/main.css">
	<link rel="stylesheet" type="text/css" href="<?php echo img_base; ?>/static/css/footer.css">
