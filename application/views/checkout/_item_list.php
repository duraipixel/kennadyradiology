            ...
            <tbody id="ordertab">
                <?php 
					...
					foreach($getcheckoutproductlist as $productlist) {
                        ...
                        $prodprice      = ($productlist['cartProductAmount'] * $productlist['product_qty']);
                        $discount       = 0;
                        ...
                        if($productlist['attr_price']==''){
                            ...
                            $printingoption = PRICE_SYMBOL .$productlist['cartProductAmount'];
                        }
                    ...
                    <tr>
                        <td>
                            ...
                            if($imgpath != ''){
										 ?>
                            <a href="<?php echo $helper->pathrevise($arrpath).'/'.$productlist['product_url']; ?>"
                            class="cart-items">

                                <img width="68" height="88"
                                    src="<?php echo img_base;?>uploads/productassest/<?php echo $productlist['product_id']; ?>/photos/<?php echo  $imgpath; ?>"
                                    alt="<?php echo $productlist['product_name']; ?>" class="img-fluid">
                                <?php }else{?>
                                <img src="<?php echo img_base;?>uploads/noimage/photos/thumb/noimage.png"
                                    alt="<?php echo $productlist['product_name']; ?>" class="img-fluid">
                                <?php }?>
                                <span><strong> <?php echo $productlist['product_name']; ?></strong>
                                    <?php echo $strAttr; ?> </span>
                            </a>
                        </td>
                        <td><?php echo $productlist['item_code']; ?></td>
                        <td><?php echo PRICE_SYMBOL.number_format($productlist['cartProductAmount'],2); ?></td>

                        <td> <?php echo $productlist['product_qty']; ?>
                        </td>
                        <td class="text-right"><strong> <?php echo number_format($prodprice,2);  ?></strong></td>
                    </tr>
                    <?php 
