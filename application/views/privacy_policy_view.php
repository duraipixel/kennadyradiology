         ...
         <div class="col">
			<nav aria-label="breadcrumb">
			  <ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page"><?php echo $footdisplaylanguage['privacypolicy'];?></li>
			  </ol>
			</nav>
			<h3 class="text-center text-white"><span><?php echo $footdisplaylanguage['privacypolicy'];?></span></h3>
		 </div>
	  </div>
	</div>
</section>
