        ...
        <div class="prdimg-wraper carousel slide" data-ride="carousel" data-interval="1000">
          ...
          <div class="prdimginner-slider carousel-inner" role="listbox">
            <?php 
								  ...
								  foreach($imgs as $i ) {								  
								  ?>
            <div class="item <?php echo $ind==0? 'active' :''; ?> prdimginner"> <img src="<?php echo img_base;?>uploads/productassest/<?php echo $p['product_id']; ?>/photos/medium/<?php echo $i; ?>" class="img-responsive center-block prdimg img-responsive prd-im" title="<?php echo $p['product_name']; ?>" alt="<?php echo $p['product_name']; ?>" /> </div>
            <?php $ind++; } ?>
          </div>
          <?php }  else {  ?>
        ...
        <div class="prdtools-wraper">
          <ul class="prdtools">
            <li class="wishlist_<?php echo $p['product_id']; ?>">
              ...
              <a href="javascript:void(0);" data-container="body" data-trigger="hover" data-toggle="popover" data-placement="top" data-content="Wishlist" data-original-title="" title="" class="wishlist-icon commonicon"  > <img src="<?php echo img_base;?>/static/images/icons/wishicon.png" class="img-responsive" alt=""> </a>
              <?php } else { ?>
              <a href="javascript:void(0);" data-container="body" data-trigger="hover" data-toggle="popover" data-placement="top" data-content="Wishlist" data-original-title="" title="" class="wishlist-icon commonicon" onclick="addtowishlist('<?php echo $p['product_id'];?>',<?php echo $p['minquantity'];?>);" > <img src="<?php echo img_base;?>/static/images/icons/wishlist-g.png" class="img-responsive" alt=""> </a>
              <?php } ?>
            </li>
            <?php if($_SESSSION['cus_group_id']==2) { ?>
            <li> <a href="javascript:void(0);" data-container="body" data-trigger="hover" data-toggle="popover" data-placement="top" data-content="Catlog"> <img src="<?php echo img_base;?>static/images/icons/file.png" class="img-responsive" alt="" /> </a> </li>
            <?php } ?>
            <li> <a href="<?php echo $helper->pathrevise($arrpath).'/'.$p['product_url']."/?customized"; ?>" data-container="body" data-trigger="hover" data-toggle="popover" data-placement="top" data-content="Customize Product"> <img src="<?php echo img_base;?>static/images/icons/edit.png" class="img-responsive" alt="" /> </a> </li>
          </ul>
        </div>
      </div>
      <?php } ?>
