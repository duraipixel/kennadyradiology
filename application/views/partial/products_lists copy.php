  ...
  <div class="col-sm-12 col-md-12 col-lg-12">
     ...
     <?php }?>
				...
				<div class="col-sm-12 col-md-6">
					...
					<a href="#" onclick="return clearallfilter();" class="clear-filter"><i class="flaticon-cancel-12"></i> Clear Filters</a></p>
				</div>
									...
									switch($f['iconsdisplay']){
										 case "1":
												 if(in_array($f['attributeid'],$arrattr))
												 {
													...
													$strattrHTML.='<div class="radio-inline color-single homecheck '.$clssel.'" onclick="prodattrchange_list(\''.$f['attributeid'].'\',\''.$fsku.'\',\''.$f['dropdown_id'].'\',\''.$p['product_url'].'\');">
