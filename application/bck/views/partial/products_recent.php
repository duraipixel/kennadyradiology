...
$imgs = '';
	  foreach($recentviewproduct['prod_list'] as $recentpro){
        ...
        <div>
          <div class="sell-wrap">
            <?php if($imgs[0] != ''){?>
            <a href="<?php echo $helper->pathrevise($arrpath).'/'.$recentpro['product_url']; ?>" > <img src="<?php echo BASE_URL;?>uploads/productassest/<?php echo $recentpro['product_id']; ?>/photos/base/<?php echo $imgs[0]; ?>" alt=""></a>
            <?php }else{?>
            <a href="<?php echo $helper->pathrevise($arrpath).'/'.$recentpro['product_url']; ?>" > <img src="<?php echo BASE_URL;?>uploads/noimage/photos/base/noimage.png" class="img-responsive center-block prdimg" title="<?php echo $p['product_name']; ?>" alt="<?php echo $p['product_name']; ?>" /></a>
            <?php }?>
