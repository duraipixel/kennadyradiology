  ...
  <div class="container">
	...
	//	print_r($catslist); die();	
		foreach($catslist as $list) {
			...
			$baseimgurl=BASE_URL.'uploads/categorymobileimage/'.$sub['categoryID']."/photos/menu/".$imgs['0'];
        ...
        <div class="prd-single"> <a href="<?php echo $cathref; ?>" class="prdsingle-inner">
          <div class="prdimginner-slider carousel-inner" role="listbox">
            <div class="item active prdimginner">
              ...
              <img src="<?php echo BASE_URL;?>uploads/categorymobileimage/<?php echo $list['categoryID']?>/photos/<?php echo $list['mobilcatimage']?>" class="img-responsive center-block prdimg" title="<?php echo $list['categoryName']; ?>" alt="<?php echo $list['categoryName']; ?>">
              <?php } else { ?>
              <img src="<?php echo BASE_URL;?>uploads/noimage/photos/medium/noimage.png" class="img-responsive center-block prdimg" title="<?php echo $list['categoryName']; ?>" alt="<?php echo $list['categoryName']; ?>" />
              <?php } ?>
            </div>
