	...
	<style>
		...
		.fpd-product-stage::before{
			content: "To many customization application doesn't support.";
			font-size: 20px;
			color: red;
				position: absolute;
				top: 10px;
    	...
    	<div id="main-container">
          	...
          	<div id="clothing-designer" class="fpd-container fpd-shadow-2 fpd-topbar fpd-tabs fpd-tabs-side fpd-top-actions-centered fpd-bottom-actions-centered fpd-views-inside-left" style="float:left">
						<h3 class="d" style="color:red; font-size:50px; "></h3>
          		<div class="fpd-product" title="Shirt Front" data-thumbnail="<?php echo $customimage;?>">
	    			<img   src="<?php echo $customimage;?>" title="Base" data-parameters='{"left": 400, "top": 400, "colors": "#d59211",   "colorLinkGroup": "Base"}' />
			  		
			  		<span title="Any Text" data-parameters='{"boundingBox": "Base", "left": 400, "top": 332, "zChangeable": true, "removable": true, "draggable": true, "rotatable": true, "resizable": true, "colors": "#000000"}' >Your Company Name </span>
								 ...
								 foreach($productfilter as $f) {
									...
									switch($f['iconsdisplay']){
										 case "1":
												 ...
												 {
													$strattrHTML.='<div class="radio-inline color-single">
																	<input type="radio" id="color1" name="iconatt_'.$f['attributeid'].'" value="'.$f['dropdown_id'].'">
