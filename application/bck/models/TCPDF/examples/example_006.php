...
$html = '<table class="table-bordered">
   <tbody>
      <tr>
         <th style="width:200px;padding:5px;">Activity Tested</th>
         <th style="padding:10px;border-top:2px solid #ffcc00;">ambattur TI</th>
         <th style="padding:10px;border-top:2px solid #ffcc00;">ambattur TI</th>
         <th style="padding:5px;border-top:2px solid #ffcc00;">Average by Activity</th>
      </tr>
      <tr>
         <td style="padding:5px;">sales</td>
         <td align="center">
            <a href="javascript:void(0);" onclick="">
               <div style="border-radius:5px;padding:5px;width:100%;background-color:#FFBE00;">
                  <div style="text-align:center;border-radius: 8px;background-color:#ffffff;width:20px;height:20px;">2.5</div>
               </div>
            </a>
         </td>
         <td align="center">
            <a href="javascript:void(0);" onclick="">
               <div style="border-radius:5px;padding:5px;width:100%;background-color:#42AADD;">
                  <div style="text-align:center;border-radius: 8px;background-color:#ffffff;width:20px;height:20px;">7.5</div>
               </div>
            </a>
         </td>
         <td align="center">
            <div style="border-radius:5px;width:100%;padding:5px;background-color:#FFDF00;">
               <div style="text-align:center;border-radius:8px;background-color:#ffffff;width:20px;height:20px;text-align:center;">5</div>
            </div>
         </td>
      </tr>
      <tr>
         <td style="padding:5px;">Activity1</td>
         <td align="center">
            <a href="javascript:void(0);" onclick="">
               <div style="border-radius:5px;padding:5px;width:100%;background-color:#ffffff;">
                  <div style="text-align:center;border-radius: 8px;background-color:#ffffff;width:20px;height:20px;">N/A</div>
               </div>
            </a>
         </td>
         <td align="center">
         ...
         <td align="center">
            <div style="border-radius:5px;width:100%;padding:5px;background-color:#ffffff;">
               <div style="text-align:center;border-radius:8px;background-color:#ffffff;width:20px;height:20px;text-align:center;">0</div>
            </div>
         </td>
      </tr>
      <tr>
         <td style="padding:5px;">Activity2</td>
         <td align="center">
            <a href="javascript:void(0);" onclick="">
               <div style="border-radius:5px;padding:5px;width:100%;background-color:#ffffff;">
                  <div style="text-align:center;border-radius: 8px;background-color:#ffffff;width:20px;height:20px;">N/A</div>
      ...
      <tr>
         <td style="padding:5px;">Activity3</td>
         <td align="center">
            <a href="javascript:void(0);" onclick="">
               <div style="border-radius:5px;padding:5px;width:100%;background-color:#ffffff;">
                  <div style="text-align:center;border-radius: 8px;background-color:#ffffff;width:20px;height:20px;">N/A</div>
      ...
      <tr>
         <td style="padding:5px;">TEST 123</td>
         <td align="center">
            <div style="border-radius:5px;width:100%;padding:5px;background-color:#ffffff;">
               <div style="text-align:center;border-radius:8px;background-color:#ffffff;width:20px;height:20px;text-align:center;">0</div>
            </div>
      ...
      <tr style="margin-top:5px;border-top:2px solid #ffcc00;">
         <td><b>Average By Unit</b></td>
         <td align="center">
            <div style="border-radius:5px;width:100%;padding:5px;background-color:#FFBE00;">
               <div style="text-align:center;border-radius:8px;background-color:#ffffff;width:20px;height:20px;text-align:center;">2.5</div>
            </div>
         </td>
         <td align="center">
            <div style="border-radius:5px;width:100%;padding:5px;background-color:#42AADD;">
               <div style="text-align:center;border-radius:8px;background-color:#ffffff;width:20px;height:20px;text-align:center;">7.5</div>
            </div>
         </td>
         <td>&nbsp;</td>
      </tr>
