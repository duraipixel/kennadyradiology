...
function getRadioBox_FormFieds( $SelName, $Attr,$AttributeID,$selId=null) {
	...
	';
        ...
        <li><a href="'.BASE_URL.$catinfo['categoryCode'].'"> <img src="'.$catimg.'" class="img-fluid" alt=""> </a> </li>
								...
								$menulink='<a class="" href="'.BASE_URL.'">';
														}
								foreach($subcat as $sub)
								{
									$baseimgurl=BASE_URL.'static/images/noimage.jpg'; 
											 ...
											 if($sub['categorymenuimage'] != ''){
												  $subhtml.='<li><a href="'.BASE_URL.$catinfo['categoryCode'].'/'.$sub['categoryCode'].'"> <img src="'.img_base_url.'category/categorymenuimage/'.$sub['categorymenuimage'].'" class="img-fluid" alt="">'.$sub['categoryName'].'</a></li>';
											 }else{
												 $subhtml.='<li><a href="'.BASE_URL.$catinfo['categoryCode'].'/'.$sub['categoryCode'].'">'.$sub['categoryName'].'</a></li>'; 
											 }
